<script lang="ts">
  ...
  async function loadEligibleFactions() {
    ...
    // Filter factions: Must be Friendly or Helpful (requirement for military aid)
  ...
  <div class="dialog-content" on:click|stopPropagation>
    ...
    <div class="dialog-body">
      <div class="info-notice">
        ...
        <span>Request military support from an allied nation. Only Friendly or Helpful factions will provide aid.</span>
      </div>

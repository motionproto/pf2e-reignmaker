...
import { initKingdomIcon, registerKingdomIconHook } from './ui/KingdomIcon';
...
function registerKingmakerHooks(): void {
    ...
    // Hook when hex editing instanceof closed (indicates hex data may have changed)
    ...
    Hooks.on("updateScene", (...args: any[]) => {
        // Check if this instanceof the kingdom scene
...
// Also initialize the Kingdom Icon module
initKingdomIcon();

...
import at.posselt.pfrpg2e.kingdom.events.KingdomEventTables
...
class KingdomEventsManager(private val game: Game) {
     ...
     */
    private fun parseOngoingEvent(raw: at.posselt.pfrpg2e.kingdom.RawOngoingKingdomEvent): OngoingEventState? {
        return try {
            OngoingEventState(
                eventId = raw.id,

  ...
  getAllActions(): PlayerAction[] {
    ...
    return [
      // Expand Borders actions
      {
        ...
        skills: [
          { skill: 'nature', description: 'harmonize with the land' }, { skill: 'survival', description: 'establish frontier camps' }, { skill: 'intimidation', description: 'force submission' }, { skill: 'occultism', description: 'mystical claiming rituals' }, { skill: 'religion', description: 'divine mandate' }
        ],
        criticalSuccess: { 
        ...
        skills: [
          { skill: 'crafting', description: 'engineering expertise' }, { skill: 'survival', description: 'pathfinding routes' }, { skill: 'athletics', description: 'manual labor' }, { skill: 'nature', description: 'work with terrain' }
        ],
        criticalSuccess: { 
        ...
        skills: [
          { skill: 'survival', description: 'wilderness navigation' }, { skill: 'nature', description: 'track and explore' }
        ],
        ...
        skills: [
          { skill: 'crafting', description: 'build fortifications' }, { skill: 'warfare', description: 'strategic placement' }
        ],
        ...
        skills: [
          { skill: 'crafting', description: 'build infrastructure' }, { skill: 'survival', description: 'identify resources' }
        ],
      ...
      // Uphold Stability actions
      {
        ...
        skills: [
          { skill: 'diplomacy', description: 'coordinate efforts' }, { skill: 'society', description: 'organize teamwork' }
        ],
        ...
        skills: [
          { skill: 'intimidation', description: 'suppress dissent' }, { skill: 'society', description: 'identify troublemakers' }
        ],
        ...
        skills: [
          { skill: 'diplomacy', description: 'calm the populace' }, { skill: 'performance', description: 'inspire the people' }, { skill: 'intimidation', description: 'quell dissent' }
        ],
      ...
      // Military Operations
      {
        ...
        skills: [
          { skill: 'warfare', description: 'military recruitment' }, { skill: 'intimidation', description: 'conscription' }
        ],
        ...
        skills: [
          { skill: 'warfare', description: 'tactical deployment' }, { skill: 'survival', description: 'logistics' }
        ],
      ...
      // Urban Planning
      {
        ...
        skills: [
          { skill: 'society', description: 'urban planning' }, { skill: 'crafting', description: 'construction' }
        ],
        ...
        skills: [
          { skill: 'crafting', description: 'construction' }, { skill: 'society', description: 'urban development' }
        ],
      ...
      // Foreign Affairs
      {
        ...
        skills: [
          { skill: 'diplomacy', description: 'negotiation' }, { skill: 'society', description: 'cultural exchange' }
        ],
        ...
        skills: [
          { skill: 'diplomacy', description: 'negotiate terms' }, { skill: 'society', description: 'find adventurers' }
        ],
      ...
      // Economic Actions
      {
        ...
        skills: [
          { skill: 'diplomacy', description: 'trade negotiations' }, { skill: 'society', description: 'market knowledge' }
        ],
        ...
        skills: [
          { skill: 'survival', description: 'resource gathering' }, { skill: 'nature', description: 'identify resources' }
        ],

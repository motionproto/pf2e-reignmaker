<script lang="ts">
  ...
  // Detect dice formula modifiers (excluding resource arrays - they're now choices)
  ...
  async function handlePrimary() {
    if ((hasChoices && !choicesResolved) || (hasDiceModifiers && !diceResolved) || (hasStateChangeDice && !stateChangeDiceResolved)) {
      return;
    }

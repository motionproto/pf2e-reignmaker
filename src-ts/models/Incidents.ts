  ...
  minorIncidents: [
    {
      ...
      skillOptions: [
        ...
        { skill: 'Society', description: 'Implement legal reform' },
    ...
    },
    {
      ...
      skillOptions: [
        ...
        { skill: 'Intimidation', description: 'Force them to work' },
        { skill: 'Performance', description: 'Inspire them' },
    ...
    },
    {
      ...
      percentileMax: 50,
      skillOptions: [
        { skill: 'Diplomacy', description: 'Convince them to stay' },
        { skill: 'Society', description: 'Address their concerns' },
    ...
    },
    {
      ...
      percentileMax: 60,
      skillOptions: [
        { skill: 'Diplomacy', description: 'Address the crowd' },
        { skill: 'Intimidation', description: 'Disperse protesters' },
        { skill: 'Performance', description: 'Distract them' },
        { skill: 'Arcana', description: 'Use magical calming' }
      ],
    ...
    },
    {
      ...
      percentileMax: 70,
      skillOptions: [
        { skill: 'Society', description: 'Investigate thoroughly' },
        { skill: 'Deception', description: 'Cover it up' },
        { skill: 'Intimidation', description: 'Purge the corrupt' },
    ...
    },
    {
      ...
      skillOptions: [
        ...
        { skill: 'Religion', description: 'Provide spiritual guidance' },
        { skill: 'Performance', description: 'Entertain the people' },
        { skill: 'Arcana', description: 'Create magical displays' }
      ],
    ...
    },
    {
      ...
      skillOptions: [
        ...
        { skill: 'Stealth', description: 'Infiltrate their ranks' },
        { skill: 'Survival', description: 'Track to their lair' },
        { skill: 'Occultism', description: 'Scry their location' }
      ],
    ...
    },
    {
      ...
      percentileMax: 100,
      skillOptions: [
        { skill: 'Diplomacy', description: 'Smooth over the issue' },
        { skill: 'Society', description: 'Make formal apology' },
  ...
  moderateIncidents: [
    {
      ...
      percentileMax: 24,
      skillOptions: [
        { skill: 'Diplomacy', description: 'Negotiate with strikers' },
        { skill: 'Society', description: 'Arbitrate the dispute' },
        { skill: 'Crafting', description: 'Work alongside them' },
    ...
    },
    {
      ...
      percentileMax: 69,
      skillOptions: [
        { skill: 'Intimidation', description: 'Suppress the riot' },
        { skill: 'Diplomacy', description: 'Negotiate with leaders' },
        { skill: 'Athletics', description: 'Contain the violence' },
    ...
    },
    {
      ...
      percentileMax: 87,
      skillOptions: [
        { skill: 'Athletics', description: 'Protect the target' },
  ...
  majorIncidents: [
    {
      ...
      skillOptions: [
        ...
        { skill: 'Intimidation', description: 'Crush the rebellion' },
    ...
    },
    {
      ...
      skillOptions: [
        ...
        { skill: 'Deception', description: 'Shift blame' },
